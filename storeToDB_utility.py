...
if __name__ == '__main__':
    ...
    csv_file = open("Output_TestSmellDetection_utility.csv", "r", encoding="ms932", errors="", newline="" )
    ...
    for row in f:
        ...
        for smell_num in range(6,27):
            ...
            project_path = row[3].replace('\\','/').replace("D:/ryosuke-ku/data_set/Git_20161108/utility/","")
